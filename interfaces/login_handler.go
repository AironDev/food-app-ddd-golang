...
import (
	"fmt"
	"github.com/airondev/food-app-ddd-golang/application"
	"github.com/airondev/food-app-ddd-golang/domain/entity"
	"github.com/airondev/food-app-ddd-golang/infrastructure/authentication"
...
type Authenticate struct {
	...
	rd authentication.AuthInterface
	tk authentication.TokenInterface
}

// NewAuthenticate Authenticate constructor
func NewAuthenticate(uApp application.UserAppInterface, rd authentication.AuthInterface, tk authentication.TokenInterface) *Authenticate {
	return &Authenticate{
		us: uApp,
		rd: rd,
		tk: tk,
